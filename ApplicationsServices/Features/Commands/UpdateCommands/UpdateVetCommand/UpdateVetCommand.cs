...
namespace ApplicationsServices.Features.Commands.UpdateCommands.UpdateVetCommand
{
    ...
    public class UpdateVetCommand : IRequest<Response<long>>
    {
    ...
    public class UpdateVetCommandHandler : IRequestHandler<UpdateVetCommand, Response<long>>
    {
        private readonly IRepository<Vet> _repository;


        public UpdateVetCommandHandler(IRepository<Vet> repository, IMapper mapper)
        {
            _repository = repository;

        }

        public async Task<Response<long>> Handle(UpdateVetCommand request, CancellationToken cancellationToken)
        {
            ...
            {
                register.vetName = request.vetName;
                register.vetSurname = request.vetSurname;
                register.vetAdress = request.vetAdress;
                register.vetPhoneNum = request.vetPhoneNum;
                register.vetIdn = request.vetIdn;
                register.specialtyId = request.specialtyId;
